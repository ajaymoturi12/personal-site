...
```bash
git clone https://github.com/ajaymoturi12/personal-site.git
cd personal-site
bun install
...
Create a `.env.local` file similar to [`.env.example`](https://github.com/ajaymoturi12/personal-site/blob/main/.env.example).
